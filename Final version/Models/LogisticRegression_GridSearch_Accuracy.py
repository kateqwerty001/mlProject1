...
param_grid = {
    'feature_selection__n_features_to_select': [21],
...
"""
Best parameters on cross-validation: {'classifier__C': 0.01, 'classifier__penalty': 'l2', 'classifier__solver': 'liblinear', 'feature_selection__n_features_to_select': 21}
"""
